...
import { AddShoppingCart, Favorite, GridView, Star } from "@mui/icons-material";
...
export default function AllProductsClient({
  ...
  // Update page in URL to trigger server fetch
    ...
    <main className="max-w-360 mx-auto px-6 py-8 lg:flex gap-8 font-[Inter,sans-serif]">
      ...
      >
        <div className="sticky top-24">
          ...
          {/* Categories */}
          <div className="mb-8 h-50 overflow-y-auto">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    >
                      {loading ? (
                        ...
                        <AddShoppingCart className="text-sm" />
                      )}
                    </button>
                  </div>
                </div>
