        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-gray-100">
              Order <span className="text-[#146875]">#MS-88294</span>
            </h2>
          </div>
        </div>
      ...
      <div className="py-6 md:py-5 md:px-3 max-w-6xl mx-auto w-full -mt-2">
        ...
        <div className="bg-[#121E20] rounded-2xl shadow-xl border border-white/5 md:p-10 p-6 mb-3">
          <div className="relative flex items-center justify-between">
            ...
            {[
              [<Check />, "Placed", "Oct 24, 10:30 AM"],
              [<Check />, "Processing", "Oct 24, 02:15 PM"],
              [<LocalShipping />, "In Transit", "Est: Oct 26"],
              [<Inventory2 />, "Delivered", ""],
            ].map((step, i) => (
              <div key={i} className="relative flex flex-col items-center">
                <div
                  ...
                  } border-4 border-[#121E20]`}
                >
                  <span className="material-symbols-outlined">{step[0]}</span>
                </div>
                <div
                  className={`mt-4 text-xs font-bold uppercase tracking-wider ${
                    i < 3 ? "text-[#146875]" : "text-[#4A5568]"
                  }`}
                >
                  {step[1]}
                </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-100">{m[1]}</h4>
              ...
              <div className="p-6 space-y-4">
                {[
                  ...
                  >
                    ...
                    <span className="text-gray-200">{row[1]}</span>
                  </div>
                ))}
